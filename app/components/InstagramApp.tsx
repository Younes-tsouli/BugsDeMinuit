                            ...
                            >
                                ...
                                <div className="flex-1 text-left overflow-hidden">
                                    <div className="flex justify-between items-start mb-1">
                                        <span className={`font-semibold text-sm ${conversation.unread ? 'text-black' : 'text-gray-600'}`}>
                ...
                <div className="h-full bg-white flex flex-col">
                    ...
                    <div className="border-t px-4 py-3 flex items-center">
                        <input
                            ...
                            disabled
                        />
                        <button className="ml-2 px-4 py-2 bg-blue-500 text-white rounded-full disabled:opacity-50" disabled>
                            Envoyer
                        </button>
                    </div>
                </div>
